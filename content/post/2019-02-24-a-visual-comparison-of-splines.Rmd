...
In this quick post we will do a visual comparison of three spline methods: splines, natural splines, and smoothing splines. If you aren't familiar with these see my [previous post](/2019/02/04/what-are-splines/). 
...
[^1]: If you really want to see it you can find it on my GitHub [here](https://github.com/asbates/nonlinear-models/blob/master/splines/univariate-comparison.R).
