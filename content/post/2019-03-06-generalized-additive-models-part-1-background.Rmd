...
This is the first post in a mini series on generalized additive models or GAMs. Here we will cover a bit of background on GAMs. This will be a high level overview because many of the ideas from before carry over. In future post(s) we will see how we can use them with data.
